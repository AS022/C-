...
namespace NewProject
{
    class Collections
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is Employee)
            {
                Collections temp = obj as Collections;//Typecastin of Reference types in C#..
    ...
    class MyConsole
    {
        ...
        class CollectionExample
        {
            ...
            {
                HashSet<Collections> data = new HashSet<Collections>();

                data.Add(new Collections { EmpID = 123, EmpName = "Phaniraj" });
                if (data.Add(new Collections { EmpID = 123, EmpName = "Phaniraj" }))
